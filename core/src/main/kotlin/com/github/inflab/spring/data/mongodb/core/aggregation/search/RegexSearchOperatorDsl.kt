...
/**
 * A Kotlin DSL to configure regex search operator using idiomatic Kotlin code.
 *
 * @author minwoo
 * @since 1.0
...
class RegexSearchOperatorDsl {
     ...
     * You can also specify a regex path to search.
    ...
    internal fun build() = Document("regex", document)
}
