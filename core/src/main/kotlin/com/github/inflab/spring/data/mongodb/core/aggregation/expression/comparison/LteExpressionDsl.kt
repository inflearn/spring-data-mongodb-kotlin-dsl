...
/**
 * A Kotlin DSL to configure `$lte` [AggregationExpression] using idiomatic Kotlin code.
 *
 * @author minwoo
 * @since 1.0
 * @see <a href="https://docs.mongodb.com/manual/reference/operator/aggregation/lte">$lte</a>
 */
@AggregationMarker
class LteExpressionDsl {
    /**
     * Represents all operands inside `$lte` as a list.
     *
     ...
     */
    infix fun Operands.lessThanEqual(value: Number): Operands {
        values.add(value)
        return this
    }
     ...
     * @param field The name of the field.
     */
    infix fun Operands.lessThanEqual(field: String): Operands {
        values.add("$$field")
        return this
    }
     ...
     * @param property The name of the field.
     */
    infix fun Operands.lessThanEqual(property: KProperty<Number?>): Operands {
        lessThanEqual(property.toDotPath())
        return this
    }
     ...
     * @param property The name of the field.
     */
    @JvmName("lessThanEqualString")
    infix fun Operands.lessThanEqual(property: KProperty<String?>): Operands {
        lessThanEqual(property.toDotPath())
        return this
    }
     ...
     * @param configuration The configuration block for the [AggregationExpressionDsl].
     */
    infix fun Operands.lessThanEqual(configuration: AggregationExpressionDsl.() -> AggregationExpression): Operands {
        values.add(AggregationExpressionDsl().configuration())
        return this
    }

    internal fun build(configuration: LteExpressionDsl.() -> Operands) = AggregationExpression { context ->
        Document(
            "\$lte",
